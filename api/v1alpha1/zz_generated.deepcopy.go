...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ConflictSummary) DeepCopyInto(out *ConflictSummary) {
	*out = *in
	if in.ConflictingProfiles != nil {
		in, out := &in.ConflictingProfiles, &out.ConflictingProfiles
		*out = make([]v1.ObjectReference, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ConflictSummary.
func (in *ConflictSummary) DeepCopy() *ConflictSummary {
	if in == nil {
		return nil
	}
	out := new(ConflictSummary)
	in.DeepCopyInto(out)
	return out
}
