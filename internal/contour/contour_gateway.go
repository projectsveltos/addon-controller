...
var ContourGatewayDeployments = []string{"gateway-system/gateway-api-admission-server", "projectcontour/contour-gateway-provisioner"}

var ContourGatewayYAML = []byte(`apiVersion: apiextensions.k8s.io/v1
