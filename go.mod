...
require (
	...
	github.com/projectsveltos/lua-utils/glua-strings v0.0.0-20250208125623-8a0f9e2ba46b // indirect
...
replace github.com/opencontainers/go-digest => github.com/opencontainers/go-digest v1.0.1-0.20250116041648-1e56c6daea3b
