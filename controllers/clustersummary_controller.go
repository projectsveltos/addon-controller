...
//+kubebuilder:rbac:groups=lib.projectsveltos.io,resources=addoncompliances,verbs=get;list;watch
//+kubebuilder:rbac:groups=lib.projectsveltos.io,resources=addoncompliances/status,verbs=get;list;update
